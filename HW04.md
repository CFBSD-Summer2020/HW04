...
![](HW04_files/figure-gfm/age_&_sex-1.png)<!-- -->
    ...
    ## [1] "The average age of female gun death victims is 44 years"
...
<!-- end list -->
    ...
    ## [1] "The season with most gun deaths is Summer with 26280 deaths in total from 2012-2014"
...
suicide. Meanwhile, hispanic population seems about the same.
...
**Answer** About police involvement and race, it seems that police
officers as not as involved with the total number of deaths per race. In
general, numbers are at least a order of magnitude less when police is
involved, that’s why a log 10 scale was necessary to observe all values
clearly inside the graph. And also why I included the table.
...
the Kolmogorov-Smirnov test results (p \< 0.001), also noticeable in the
violin plot, so the Mann-Whitman-Wilcoxon test is a better option to
assess statistical differences between groups. Although I didn’t test
for heterocedasticity. Police involvent in significantly different when
comparing age victims
